...
-- PC
INSERT INTO items VALUES(seq_items.NEXTVAL,'ビジネスノートPC',79800,'仕事向けノートPC',15,NULL,3,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'クリエイターPC',158000,'動画編集向け',8,NULL,3,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'エントリーPC',59800,'初心者向けPC',20,NULL,3,0,SYSDATE);

-- マウス
INSERT INTO items VALUES(seq_items.NEXTVAL,'Bluetoothマウス',2480,'持ち運び向け',20,NULL,4,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'静音マウス',1980,'クリック音軽減',20,NULL,4,0,SYSDATE);

-- キーボード
INSERT INTO items VALUES(seq_items.NEXTVAL,'テンキーレスキーボード',4980,'省スペース',15,NULL,5,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'Bluetoothキーボード',3980,'無線接続',15,NULL,5,0,SYSDATE);

-- モニター
INSERT INTO items VALUES(seq_items.NEXTVAL,'34インチウルトラワイドモニター',49800,'作業効率向上',5,NULL,6,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'4Kモニター',59800,'高解像度',5,NULL,6,0,SYSDATE);

-- マイク
INSERT INTO items VALUES(seq_items.NEXTVAL,'配信用USBマイク',7980,'初心者配信向け',10,NULL,7,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'ダイナミックマイク',15800,'ノイズに強い',5,NULL,7,0,SYSDATE);

-- Webカメラ
INSERT INTO items VALUES(seq_items.NEXTVAL,'4K Webカメラ',19800,'高画質配信向け',5,NULL,8,0,SYSDATE);
INSERT INTO items VALUES(seq_items.NEXTVAL,'広角Webカメラ',5980,'会議向け',10,NULL,8,0,SYSDATE);
