...
CREATE TABLE reviews (
    id NUMBER(10,0) DEFAULT seq_reviews.NEXTVAL PRIMARY KEY,
...
CREATE TABLE coupons (
    id NUMBER(10,0) DEFAULT seq_coupons.NEXTVAL PRIMARY KEY,
...
CREATE TABLE gacha_logs (
    id NUMBER(10,0) DEFAULT seq_gacha_logs.NEXTVAL PRIMARY KEY,
    user_id NUMBER(10,0) NOT NULL,
